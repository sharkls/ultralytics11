#ifndef ObjectDetectionACTIVITY_H
#define ObjectDetectionACTIVITY_H
...
#include "activities/ObjectDetectionActivity/proto/ObjectDetectionActivity.pb.h"
...
#include "include/Interface/ExportObjectDetectionAlgLib.h"
...
class ObjectDetectionActivity : public ActivityBase
{
public:
    ...
    // 软件处理算法结果的回调函数
    void GetObjectDetectionResultResponseMessageCallbackFunc(const CAlgResult& res_message, void* data_handle);
...
private:
    ...
    CSafeDataDeque<std::shared_ptr<CAlgResult>> object_detection_result_deque_;  // 多模态融合结果
    ...
    // 算法实例
    IObjectDetectionAlg *object_detection_alg_{nullptr};
...
#endif // ObjectDetectionACTIVITY_H