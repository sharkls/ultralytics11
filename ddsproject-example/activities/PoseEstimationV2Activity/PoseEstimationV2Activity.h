...
#include "activities/PoseEstimationV2Activity/proto/PoseEstimationV2Activity.pb.h"
...
class PoseEstimationV2Activity : public ActivityBase
{
public:
    PoseEstimationV2Activity();
    ~PoseEstimationV2Activity();
