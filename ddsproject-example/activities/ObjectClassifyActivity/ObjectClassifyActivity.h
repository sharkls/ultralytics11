#ifndef POSEESTIMATIONV2ACTIVITY_H
#define POSEESTIMATIONV2ACTIVITY_H
...
#include "activities/ObjectClassifyActivity/proto/ObjectClassifyActivity.pb.h"
...
#include "include/Interface/ExportObjectClassifyAlgLib.h"
...
class ObjectClassifyActivity : public ActivityBase
{
public:
    ObjectClassifyActivity();
    ~ObjectClassifyActivity();

    // 软件处理算法结果的回调函数
    void GetObjectClassifyResultResponseMessageCallbackFunc(const CAlgResult& res_message, void* data_handle);
...
private:
    ...
    // 算法实例
    IObjectClassifyAlg *pose_estimation_alg_{nullptr};
...
#endif // POSEESTIMATIONV2ACTIVITY_H