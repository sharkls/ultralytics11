...
/*!
 * @file CMultiModalSrcDataCdrAux.ipp
 * This source file contains some declarations of CDR related functions.
 *
 * This file was generated by the tool fastddsgen.
 */

#ifndef _FAST_DDS_GENERATED_CMULTIMODALSRCDATACDRAUX_IPP_
#define _FAST_DDS_GENERATED_CMULTIMODALSRCDATACDRAUX_IPP_
        ...
        size_t& current_alignment)
{
    ...
    size_t calculated_size {calculator.begin_calculate_type_serialized_size(
        ...
        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(2),
                data.vecDistanceInfo(), current_alignment);
        ...
        const CDisparityResult& data)
{
    ...
    scdr
        << eprosima::fastcdr::MemberId(0) << data.usWidth()
        << eprosima::fastcdr::MemberId(1) << data.usHeight()
        << eprosima::fastcdr::MemberId(2) << data.vecDistanceInfo()
;
    scdr.end_serialize_type(current_state);
}
...
#endif // _FAST_DDS_GENERATED_CMULTIMODALSRCDATACDRAUX_IPP_
