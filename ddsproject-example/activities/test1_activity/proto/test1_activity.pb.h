...
/* @@protoc_insertion_point(class_definition:TopicConfig) */ {
 ...
 public:
  ...
  std::string* mutable_counter_topic();
  [[nodiscard]] std::string* release_counter_topic();
  void set_allocated_counter_topic(std::string* value);
  ...
  std::string* _internal_mutable_counter_topic();
...
PROTOBUF_ALWAYS_INLINE void TopicConfig::set_counter_topic(Arg_&& arg,
                                              Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline std::string* TopicConfig::mutable_counter_topic() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* TopicConfig::_internal_mutable_counter_topic() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.counter_topic_.Mutable( GetArena());
}
inline std::string* TopicConfig::release_counter_topic() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void TopicConfig::set_allocated_counter_topic(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
