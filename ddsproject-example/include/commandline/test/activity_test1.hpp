#ifndef COMMANDLINE_TEST_ACTIVITY_TEST_HPP
#define COMMANDLINE_TEST_ACTIVITY_TEST_HPP
...
private:
    DataQueue<MessageWaitForDeal>* message_wait_for_deal_queue_;
    std::thread* deal_data_customer_thread_{nullptr};

    DataQueue<MessageResDisplay>* message_res_display_queue_;
