...
from ultralytics.data.dataset import GroundingDataset, YOLODataset, YOLOMultiModalDataset, YOLOMultiModalFusionDataset
...
# TODO:多模态数据集
def build_multimodal_dataset(cfg, img_path, img_path2, batch, data, mode="train", rect=False, stride=32):
    """Build YOLO Dataset."""
    return YOLOMultiModalFusionDataset(
        img_path=img_path,
        img_path2=img_path2,
        imgsz=cfg.imgsz,
        batch_size=batch,
...
def load_inference_source_multimodal(source=None, batch=1, vid_stride=1, buffer=False):
    """
    Loads an inference source for object detection and applies necessary transformations.
