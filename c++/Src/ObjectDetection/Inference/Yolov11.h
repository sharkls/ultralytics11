...
class Yolov11 : public IBaseModule {
public:
    Yolov11(const std::string& exe_path);
    ~Yolov11() override;

    std::string getModuleName() const override { return "Yolov11"; }
...
private:
    objectdetection::YOLOModelConfig m_poseConfig;       // 配置参数
