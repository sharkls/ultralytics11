...
def parse_opt():
    ...
    parser.add_argument('--annotation_path', type=str, default='data/LLVIP/Annotations', help='folder containing xml files')
    parser.add_argument('--image_path', type=str, default='data/LLVIP/infrared/test', help='image path, e.g. /root/LLVIP/infrared/train')
    parser.add_argument('--txt_save_path', type=str, default='data/LLVIP/labels/test', help='txt path containing txt files in yolov5 format')
