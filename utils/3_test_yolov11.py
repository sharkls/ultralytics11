...
model = YOLOMultimodal("yolo11s-EFDEA.yaml", task="multimodal").load('/ultralytics/runs/detect/train8/weights/last.pt')  # load an official model
# Load a model
...
# Validate the model
metrics = model.val(data="multimodal.yaml", batch=2, imgsz=640, device=0)  # no arguments needed, dataset and settings remembered
