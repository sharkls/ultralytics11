...
def parse_args():
    ...
    parser.add_argument('--image_paths', nargs='+', default=['/ultralytics/data/Data/0703/extracted_targets/images_0624_split/test/0/0531tmp1_234_class0_0006.jpg','/ultralytics/data/Data/0703/extracted_targets/images_0624_split/test/2/0531tmp4_0531tmp3_526_class2_0002.jpg'], help='输入图像路径列表')
