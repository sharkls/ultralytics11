...
def main():
    ...
    parser.add_argument('--onnx', type=str, default="runs/multimodal/train76/weights/best0529.onnx", help='ONNX模型路径')
    parser.add_argument('--engine', type=str, default="runs/multimodal/train76/weights/best32.engine", help='保存engine的路径')
    parser.add_argument('--max-batch-size', type=int, default=1, help='最大batch size')
    parser.add_argument('--fp16', default = False, help='使用FP16精度')
    parser.add_argument('--verify', default=True, help='验证engine')
    parser.add_argument('--rgb', type=str, default="data/Myself-v3-clean/images/visible/test/001624.jpg", help='RGB图像路径')
    parser.add_argument('--ir', type=str, default="data/Myself-v3-clean/images/infrared/test/001624.jpg", help='红外图像路径')
    parser.add_argument('--homography', type=str, default="data/Myself-v3-clean/extrinsics/test/001624.txt", help='单应性矩阵路径')
    parser.add_argument('--conf-thres', type=float, default=0.25, help='置信度阈值')
    parser.add_argument('--visualize', default=True, help='是否可视化结果')
    parser.add_argument('--save-dir', type=str, default="runs/tensorrt_vis-myself32-v3", help='可视化结果保存目录')
