...
model.predict(source=[['runs/extract_frame/visible_frame10.jpg', 'runs/extract_frame/infrared_frame10.jpg', mapping_matrix]], save=True, imgsz=640, conf=0.5, device=0) # corresponding image pair
